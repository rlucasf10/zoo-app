...
<head>
    ...
    <link rel="stylesheet" href="/zoo-app/assets/css/style.css">
    <link rel="stylesheet" href="/zoo-app/assets/css/login_register.css">
</head>
...
<body>
    <header>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm">
            <div class="container">
                <a class="navbar-brand font-weight-bold" href="/zoo-app/index.php">Zoo App</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul id="navbar-item" class="navbar-nav mx-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="/zoo-app/index.php">Inicio</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/zoo-app/views/reservas.php">Reservas</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/zoo-app/views/animales.php">Animales</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/zoo-app/views/itinerarios.php">Itinerario</a>
                        </li>
                    </ul>
                        ...
                        <?php else: ?>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="userDropdown">
                                    <a class="dropdown-item" href="/zoo-app/views/perfil.php">
                                        <i class="fas fa-user-circle"></i> Mi Perfil
                                    </a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="/zoo-app/views/login_register/logout.php">
